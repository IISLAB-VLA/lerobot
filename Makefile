...
# Default CI target — always rebuilds the Vite bundle so Playwright never serves
# a stale dist/. Use ``dashboard-e2e-nobuild`` for the fast dev-inner-loop when
# you know the bundle is fresh.
